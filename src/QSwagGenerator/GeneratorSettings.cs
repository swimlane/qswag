...
namespace QSwagGenerator
{
  ...
  public class GeneratorSettings
  {
    ...
    public GeneratorSettings(HttpRequest request)
    {
      ...
      if (Enum.TryParse(request.Scheme, true, out Protocol protocol))
    ...
    /// <summary>
    /// Gets or sets the validate options.
    /// </summary>
    /// <value>
    /// The validate options.
    /// </value>
    public ValidateOptions ValidateOptions { get; set; } = new ValidateOptions();
  }
}